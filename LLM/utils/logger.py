...
class Logger(object):
    ...
    def _create_logger(self):
        ...
        # expose json logging paths for training process
        base_dir = os.path.dirname(os.path.normpath(folder_name))
        self.args.log_jsonl_path = os.path.join(base_dir, 'train.jsonl')
        self.args.log_best_path = os.path.join(base_dir, 'best.json')
